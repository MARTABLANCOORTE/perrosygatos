...
function FilterByProvincia({ handleFilterProvincia }) {
  const handleInputProvincia = (event) => {
    handleFilterProvincia(event.currentTarget.value);
  };
...
FilterByProvincia.propTypes = {
  handleInputProvincia: PropTypes.func,
  handleFilterProvincia: PropTypes.func,
};

export default FilterByProvincia;
